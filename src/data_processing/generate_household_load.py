...
def get_household_load():
    ...
    # Define the inputs data_processing directory and file path relative to the project root
    household_load_dir = os.path.join('/Users/noahdimonti/Developer/PycharmProjects/EV_apartment_model', 'data/household_load')
