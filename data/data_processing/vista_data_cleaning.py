...
def main(start_date_time=params.start_date_time, min_at_home_time=params.min_time_at_home):
    ...
    vista_raw_path = '../inputs/raw/T_VISTA1218_V1.csv'
    work_ev_path = '../inputs/raw/VISTA_Time_HomeDeAr_WorkVehicle.csv'
    casual_ev_path = '../inputs/raw/VISTA_Time_HomeDeAr_CasualVehicle.csv'
